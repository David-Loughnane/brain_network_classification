...
def functional_parcellation_mapping(subject, hemisphere, parcel_mapping, parcel_counts):
...
left_parcellated_ts = functional_parcellation_mapping("L")
right_parcellated_ts = functional_parcellation_mapping("R")
...
parcels = np.array(parcels_source[0][0][0][0][0])
